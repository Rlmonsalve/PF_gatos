...
public class TinyDB {
    ...
    public ArrayList<Gato> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();

    	ArrayList<String> objStrings = getListString(key);
    	ArrayList<Gato> objects =  new ArrayList<Gato>();

    	for(String jObjString : objStrings){
    		Gato value  = (Gato) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }

    public ArrayList<Objeto> getListObjectItem(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Objeto> objects =  new ArrayList<Objeto>();

        for(String jObjString : objStrings){
            Objeto value  = (Objeto) gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }

    public ArrayList<Sitio> getListObjectSite(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Sitio> objects =  new ArrayList<Sitio>();

        for(String jObjString : objStrings){
            Sitio value  = (Sitio) gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<Gato> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    ...
    public void putListObjectItem(String key, ArrayList<Objeto> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
    ...
    public void putListObjectSite(String key, ArrayList<Sitio> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
